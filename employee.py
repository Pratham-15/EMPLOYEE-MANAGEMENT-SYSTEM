...
class Employee :
    def __init__(self,root) :
        ...
        self.root.title("made by Pratham Kumar")
        ...
        img1 = img1.resize((1340,160))
        self.photo1 = ImageTk.PhotoImage(img1)

        self.img_1 = Label(img_frame,image=self.photo1)
        self.img_1.place(x=0,y=0,width=1340,height=160)
        ...
        # upper frame
        upper_frame = LabelFrame(Main_frame,bd=2,relief="ridge",bg='#ece4db',
        ...
        #Add Employee Image
        employeeImg= Image.open('images/empImages.png')
        ...
        button_frame = Frame(upper_frame,bd=2,relief='ridge',bg='#ece4db')
        ...
        # down frame
        down_frame = LabelFrame(Main_frame,bd=2,relief="ridge",bg='#ece4db',
...
if __name__ == "__main__" :
    root = Tk()
    # img = PhotoImage(file='images/empImages.png')
